    ...
    <div className={s.main}>
        ...
        <div className={s.action}>
          <div className={s.descript}>
            ...
            <p className={s.text}>Помимо прогнозов у нас есть интересные развлечения. Отличные мини-игры, увлекательные задания и игровой магазин с предметами ждут вас. Присоединяйтесь к нам и наслаждайтесь моментом с нами.</p>
            </div>
